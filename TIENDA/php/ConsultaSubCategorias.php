  ...
  <form id='formulario' name='formulario'  role='form' method='POST' enctype='multipart/form-data'>  
      <div class='container'>
        <div class='panel panel-default'>
            <div class="panel-heading" style="font-size: 20px;color:#0080FF;font-weight:bold;">CONSULTA DE SUB CATEGORIAS
              ...
              <?php if($PermisoCrear=='S')
                  {
                    echo "<button class='btn btn-primary btn-sm' title='Nuevo' style='font-size:18px;color:#0080FF;background-color:    #FFBF00;border:none' onClick='window.location=\"NuevoSubCategoria.php\"' type='button'> <span class='".$IconoCrear."'></span> </button>";
                  }?>
            </div>
        ...
        <div id='tableContainer' class='tablaContainer'>
            ...
            <thead class='fixedHeader' >
                <tr >
                    <th bgcolor='#FFBF00' style='color: #0080FF'><b><center>Id Sub Categoría</center></b></th>
                    <th bgcolor='#FFBF00' style='color: #0080FF'><b><center>Categoría</center></b></th>
            ...
            <tbody class='scrollContent'  >
                <?php 
                    ...
                    while($registro=  mysqli_fetch_array($ResultSet))
                    {
                      ...
                      echo  
                      "<tr>
                        <td><center>".$registro['IdSubCategoria']."</center></td>   
                        <td>".$registro['DescripcionCategoria']."</td>                                
                        <td>".$registro['DescripcionSubCategoria']."</td>  
                        <td>".$descEstado."</td>";
                      echo "<td><center>";
                      if($PermisoModificar=='S'){
                        echo "<a href=ModificarSubCategoria.php?IdSubCategoria=".$registro['IdSubCategoria']."><span class='".$IconoModificar."'></span></a>";
                      }
                      echo "&nbsp&nbsp";
                      if($PermisoEliminar=='S'){
                        echo "<a href=EliminarSubCategoria.php?IdSubCategoria=".$registro['IdSubCategoria']."><span class='".$IconoEliminar."'></span></a>";
                      }
                      echo "</td></tr>";
                    ...
                    if($contador==0)
                    {
                        echo "<h2>No existen Sub Categorías</h2>";   
                    }?>
                </tbody>               
            </table>
              </div>
