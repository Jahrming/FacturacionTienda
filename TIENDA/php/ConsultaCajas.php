  ...
  <form id='formulario' name='formulario'  role='form' method='POST' enctype='multipart/form-data'>  
      <div class='container'>
        <div class='panel panel-default'>
            <div class="panel-heading" style="font-size: 20px;color:#0080FF;font-weight:bold;">CONSULTA DE CAJAS
              ...
              <?php if($PermisoCrear=='S')
                  {
                    echo "<button class='btn btn-primary btn-sm' title='Nuevo' style='font-size:18px;color:#0080FF;background-color:    #FFBF00;border:none' onClick='window.location=\"NuevoCaja.php\"' type='button'> <span class='".$IconoCrear."'></span> </button>";
                  }?>
            </div>
        ...
        <div id='tableContainer' class='tablaContainer'>
            ...
            <thead class='fixedHeader' >
                <tr >
                    <th bgcolor='#FFBF00' style='color: #0080FF'><b><center>Id Almacen</center></b></th>
                    <th bgcolor='#FFBF00' style='color: #0080FF'><b><center>Id Caja</center></b></th>
                    <th bgcolor='#FFBF00' style='color: #0080FF'><b><center>Descripción Caja</center></b></th>
            ...
            <tbody class='scrollContent'  >
                <?php 
                    ...
                    while($registro=  mysqli_fetch_array($ResultSet))
                    {
                      ...
                      echo  
                      "<tr>
                        <td><center>".$registro['IdAlmacen']."</center></td>  
                        <td><center>".$registro['IdCaja']."</center></td>  
                        <td><center>".$registro['DescripcionCaja']."</center></td>  
                        <td>".$descEstado."</td>";
                      echo "<td><center>";
                      if($PermisoModificar=='S'){
                        echo "<a href=ModificarCaja.php?IdCaja=".$registro['IdCaja']."><span class='".$IconoModificar."'></span></a>";
                      }
                      echo "&nbsp&nbsp";
                      if($PermisoEliminar=='S'){
                        echo "<a href=EliminarCaja.php?IdCaja=".$registro['IdCaja']."><span class='".$IconoEliminar."'></span></a>";
                      }
                      echo "</td></tr>";
