  ...
  <form id='formulario' name='formulario'  role='form' method='POST' enctype='multipart/form-data'>  
      <div class='container'>
        <div class='panel panel-default'>
            <div class="panel-heading" style="font-size: 20px;color:#0080FF;font-weight:bold;">CONSULTA DE CATEGORIAS
              ...
              <?php if($PermisoCrear=='S')
                  {
                    echo "<button class='btn btn-primary btn-sm' title='Nuevo' style='font-size:18px;color:#0080FF;background-color:    #FFBF00;border:none' onClick='window.location=\"NuevoCategoria.php\"' type='button'> <span class='".$IconoCrear."'></span> </button>";
                  }?>
            </div>
        ...
        <div id='tableContainer' class='tablaContainer'>
            ...
            <thead class='fixedHeader' >
                <tr >
                    <th bgcolor='#FFBF00' style='color: #0080FF'><b><center>Id Categoría</center></b></th>
            ...
            <tbody class='scrollContent'  >
                <?php 
                    ...
                    {
                      $contador++;
                      $v_Estado=$registro['EstadoCategoria'];
                      ...
                      echo  
                      "<tr>
                        <td><center>".$registro['IdCategoria']."</center></td>   
                        <td>".$registro['DescripcionCategoria']."</td>  
                        <td>".$descEstado."</td>";
                      echo "<td><center>";
                      if($PermisoModificar=='S'){
                        echo "<a href=ModificarCategoria.php?IdCategoria=".$registro['IdCategoria']."><span class='".$IconoModificar."'></span></a>";
                      }
                      echo "&nbsp&nbsp";
                      if($PermisoEliminar=='S'){
                        echo "<a href=EliminarCategoria.php?IdCategoria=".$registro['IdCategoria']."><span class='".$IconoEliminar."'></span></a>";
                      }
                      echo "</td></tr>";
