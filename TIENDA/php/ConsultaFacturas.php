  ...
  <form id='formulario' name='formulario'  role='form' method='POST' enctype='multipart/form-data'  action='DescargarXML.php'>  
      <div class='container'>
        <div class='panel panel-default'>
            ...
            <div class="panel-heading" style="font-size: 20px;color:#0080FF;font-weight:bold;" width="75%">CONSULTA DE FACTURAS
           ...
           <table class='table table-bordered table-hover' id='tabla1'>
            ...
            <thead class='fixedHeader' >
              <tr>
                ...
                <th bgcolor='#FFFF00' style='color: #0080FF' width='7%'><b><center>Sec SRI</center></b></th>                
                  ...
                  success: function(data)
                  {
                   ...
                   for(i=0;i<nregs;i++)
                   {
                    ...
                    contador++;
                     ...
                     var imp  = parseFloat(data.Impuesto[i]);
                     ...
                     html="<tr><td style='color:#000000'>"+data.DescripcionAlmacen[i]+"</td>"+
                        ...
                        //  '<td>'+data.TipDoc[i]+'</td>'+
                          "<td style='color:#000000; text-align:right;'>"+data.IdMov[i]+'</td>'+
                          "<td style='color:#100719; text-align:right;'>"+data.FactSri[i]+'</td>'+
                          ...
                          "<td style='color:#100719'><a href='#' onClick=popup_detalle_factura('"+data.IdMov[i]+"') ><span title='Detalle de la Factura'><img src='../img/detalle.png'></span></a>&nbsp&nbsp"+
