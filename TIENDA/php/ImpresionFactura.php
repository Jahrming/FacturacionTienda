<?php
    ...
    else
    {
        ...
        $StrSql="select * from systemprofile where IdEmpresa=";
        $ResultSet= mysqli_query($conexion,$StrSql);
    ...
    //echo $CodigoHtml;
                            ...
                            // $documentopdf->setPaper('A4','PORTRAIT');
                             ...
                             $documentopdf->stream("ComprobanteVenta".$xIdMov.".pdf");
   
    // IMPRESION DE LOS NÚMEROS DE SERIE AL REVERSO DE LA FACTURA       
  /*  $CodigoHtml="";
    $CodigoHtml.="            
    <!DOCTYPE html>
    <html>
