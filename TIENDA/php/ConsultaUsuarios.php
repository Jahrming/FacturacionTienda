  ...
  <form id='formulario' name='formulario'  role='form' method='POST' enctype='multipart/form-data'>  
      <div class='container'>
        <div class='panel panel-default'>
            <div class="panel-heading" style="font-size: 20px;color:#0080FF;font-weight:bold;">CONSULTA DE USUARIOS
              ...
              <?php if($PermisoCrear=='S')
                  {
                    echo "<button class='btn btn-primary btn-sm' title='Nuevo' style='font-size:18px;color:#0080FF;background-color:    #FFBF00;border:none' onClick='window.location=\"NuevoUsuario.php\"' type='button'> <span class='".$IconoCrear."'></span> </button>";
                  }?>
            </div>
        ...
        <div id='tableContainer' class='tablaContainer'>
            ...
            <thead class='fixedHeader' >
                <tr >
                    ...
                    <th bgcolor='#FFBF00' style='color: #0080FF'><b><center>UserName</center></b></th>
            ...
            <tbody class='scrollContent'  >
                <?php 
                    $contador=0;
                    $StrSql="SELECT a.IdUsuario as IdUsuario,a.UserName as UserName,
                                    a.ApellidosUsuario as Apellidos,a.NombresUsuario as Nombres,
                                    b.DescripcionTipoUsuario as DescTipoUsuario,
                                    a.EmailUsuario as email ,a.EstadoUsuario as estado 
                             FROM admusuarios a,admtipousuario b
                    ...
                    while($registro=  mysqli_fetch_array($ResultSet))
                    {
                      ...
                      if($PermisoModificar=='S'){
                        echo "<a href=ModificarUsuarios.php?IdUsuario=".$registro['IdUsuario']."><span class='".$IconoModificar."'></span></a>";
                      }
                      echo "&nbsp&nbsp";
                      if($PermisoEliminar=='S'){
                        echo "<a href=EliminarUsuarios.php?IdUsuario=".$registro['IdUsuario']."><span class='".$IconoEliminar."'></span></a>";
                      }
                      echo "</td></tr>";
